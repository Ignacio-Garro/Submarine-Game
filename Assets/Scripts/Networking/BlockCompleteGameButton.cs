...
public class BlockCompleteGameButton : NetworkBehaviour, IInteractuableObject
{
    ...
    public void OnInteract(GameObject playerThatInteracted)
    {
        ...
        InputManager.Instance.onInteractPressedAfterBlock += ExitBlockButton;
    ...
    public void ExitBlockButton(GameObject player, Camera camera)
    {
